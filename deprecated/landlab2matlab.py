...
from landlab.testing.tools import cdtemp # to save grids
from landlab.io.esri_ascii import write_esri_ascii # to save grids
...
ymax = 500.                 # width of the domain [meters]
dxy = 5.                   # pixel size as the length of one side [meters] %fast
...
total_time  = 4000      # Maximum time the simulation can run for [kyr]
shear_start = 3000      # Time to start the off-fault deformation [kyr]
dt          = 10.0       #time_step of the for loop [kyr]
dt_during_shear = 1  #time steps during shear

current_time= 0         # time tracking variable [kyr]
i           = 0         # iteration tracker [integer]
plot_num    = 1000       # number of iterations to run before each new plot
